...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: `### \n\`\`\`js\nimport { Slider, Slide } from 'crow-ui/Slider';\nOr\nimport { Slider, Slide } from 'crow-ui';\n\`\`\``,
      },
    },
  },
  argTypes: {
...
export const Default: Story = {
  args: {
    containerClassName: 'crow:w-[400px]',
    ...
    children: Array(5)
      ...
      .map((_, index) => (
        <Slide key={index}>
          <div className="crow:h-[200px] crow:bg-gray-600 crow:rounded crow:flex crow:items-center crow:justify-center crow:text-white">
            {index + 1}
          </div>
        </Slide>
      )),
