  ...
  return (
    <>
      ...
      <p className={DESCRIPTION_CLASS}>
        <strong>crow-ui</strong> is a modern, accessible, and themeable component library built for
        React applications. It offers a comprehensive set of pre-styled, reusable components
        designed to speed up development and ensure visual consistency across projects.
        <br />
      ...
      <p className={DESCRIPTION_CLASS}>
        Install <strong>crow-ui</strong> using your preferred package manager.
      </p>
      <Source
        language="bash"
        code={`npm install crow-ui
